...
class DemenagementDetail extends StatefulWidget {
  const DemenagementDetail({super.key});

  @override
  State<DemenagementDetail> createState() => _DemenagementDetailState();
}

class _DemenagementDetailState extends State<DemenagementDetail> {
  int is_selected = 1;
  @override
